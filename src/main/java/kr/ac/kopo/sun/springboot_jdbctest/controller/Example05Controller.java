...
import kr.ac.kopo.sun.springboot_jdbctest.domain.Product;
import kr.ac.kopo.sun.springboot_jdbctest.repository.DetailRepository;
import kr.ac.kopo.sun.springboot_jdbctest.repository.ProductRepository;
...
public class Example05Controller {
    ...
    public String requestInsert(Model model) {
        ...
        detail.setDescription("IPhone 17 2025");
